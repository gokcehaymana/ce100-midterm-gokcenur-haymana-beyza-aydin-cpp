...
call reportgenerator "-title:Project Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:Project Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for Project
call OpenCppCoverage.exe --export_type=binary:project_tests_unit_win.cov --sources src\project\src --sources src\project\header --sources src\tests\project -- build_win\build\Debug\project_tests.exe

echo Generate Test Coverage Data for Project App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=project_tests_unit_win.cov --export_type=cobertura:projectapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\project\src --sources src\project\header --sources src\projectapp\src --sources src\projectapp\header --sources src\tests\utility --sources src\tests\project -- build_win\build\Debug\projectapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:Project Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/projectapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/project/src;src/project/header;src/projectapp/src;src/projectapp/header;src/tests/utility;src/tests/project" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/projectapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/project/src;src/project/header;src/projectapp/src;src/projectapp/header;src/tests/utility;src/tests/project" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\project\header "build_win\build\Release" /E
call robocopy src\projectapp\header "build_win\build\Release" /E
...
call robocopy src\project\header "build_win\build\Debug" /E
call robocopy src\projectapp\header "build_win\build\Debug" /E
